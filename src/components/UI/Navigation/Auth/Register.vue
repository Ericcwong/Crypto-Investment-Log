<template>
  <div class="relative">
    <button @click="isOpen = true">Sign Up</button>
      ...
      >
        <div class="bg-gray-50 w-96 p-3 border border-black rounded-md">
          ...
          <form class="flex flex-col">
            <label class="pt-2 pb-1" for="email">Email Address</label>
            <input
              class="border border-black p-1 rounded"
              type="email"
              placeholder="Enter your email address..."
            />
            <label class="pt-2 pb-1" for="password">Password</label>
            <input
              class="border border-black p-1 rounded"
              type="password"
              placeholder="Enter your password..."
            />
            <label class="pt-2 pb-1" for="password">Reenter Password</label>
            ...
            />
            <button class="mt-3 rounded bg-gray-200">Sign up</button>
          </form>
          <h3 class="pt-4">Sign up with</h3>
          <h4>
